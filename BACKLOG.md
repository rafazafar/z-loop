...
- **UI-01 — Complete.** Repository work and activity have server search and pagination. The manager searches work across repositories. Full run history remains available per work ID.
